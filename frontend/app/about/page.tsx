    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 bg-slate-50 rounded-2xl p-12">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mb-2">Carey Okal</h2>
              <p className="text-lg text-slate-600 mb-6">Founder</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            onClick={() => router.push('/')}
            className="px-8 py-4 bg-white text-slate-900 rounded-lg hover:bg-slate-100 transition-all font-medium shadow-lg hover:shadow-xl"
          >
            Get Started
          </button>
        </div>

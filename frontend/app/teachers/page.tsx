    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 relative overflow-hidden">
      ...
      <section className="relative pt-16 sm:pt-20 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="text-sm sm:text-base text-[#737373] mb-2 font-medium">For Teachers</div>
          ...
          <p className="text-xl sm:text-2xl text-[#737373] max-w-2xl mx-auto leading-relaxed">
            Create, manage, and track student progress with ease
          </p>
        </div>
      </section>
          ...
          <div className="space-y-24 sm:space-y-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative">
              ...
              <div className="space-y-6 relative z-10">
                <h3 className="text-3xl sm:text-4xl font-semibold text-[#1f1f1f] leading-tight">Create a Classroom</h3>

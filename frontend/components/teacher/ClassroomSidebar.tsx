...
export function ClassroomSidebar({
  ...
  return (
    <div className="w-72 bg-white border-r border-slate-100 flex flex-col h-screen z-30 relative">
      {/* Header */}
      <div className="p-6 pb-5 border-b border-slate-100">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base font-light text-slate-900 tracking-tight">My Classrooms</h2>
          {onClose && (
            <button
              onClick={onClose}
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-colors text-xs font-medium shadow-sm hover:shadow-md"
        >
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="font-light text-slate-900 mb-0.5 text-sm tracking-tight truncate">{classroom.name}</div>
                        ...
                        <div className="flex items-center mt-1.5 text-xs text-slate-400">
                          <span className="font-mono bg-slate-50 px-2 py-0.5 rounded text-[10px] font-light">
                            {classroom.join_code}
                          </span>
                        </div>
                      </div>
